def main_after_150_days() :
    import os #for giving adress to where we want to save output files
    from openpyxl import load_workbook
    wb = load_workbook('MainDataset_after_150_days.xlsx')
    ws = wb.active
    name=[]
    number_of_posts = []
    number_of_followers = []
...
name_150,number_of_posts_150,number_of_followers_150,number_of_followings_150,mean_like_for_all_users_150,number_of_self_picture_posts_form_9_previous_posts_150,sex_150,narcissism_150,ratio_of_followings_to_followers_for_all_users_150, mean_like_to_follower_for_all_users_150 ,cc_150 , cx_150 , cxx_150 , cxxx_150, cy_150 , cyy_150 , cyyy_150 , cq_150 = main_after_150_days()
name,number_of_posts,number_of_followers,number_of_followings,mean_like_for_all_users,number_of_self_picture_posts_form_9_previous_posts,sex,narcissism,ratio_of_followings_to_followers_for_all_users,mean_like_to_follower_for_all_users,cc , cx , cxx , cxxx, cy , cyy , cyyy , cq = main_dataset()
...
print (" --------------------------------------------------------------------------------------------------------------------- ")
print (" ------------------------------------ M.A.I.N D.A.T.A.S.E.T A.F.T.E.R 150 D.A.Y.S ------------------------------------ ")
